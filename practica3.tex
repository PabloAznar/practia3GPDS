...
\textbf{Definición e implementación de pruebas unitarias}
\begin{\begin{itemize}
  \item Horas: 16 horas.
  \item Fechas: jueves y viernes .Semana 8
\end{itemize}}

\textbf{Definición e implementación de pruebas de integración}
\begin{\begin{itemize}
  \item Horas: 16 horas.
  \item Fechas: lunes y martes . Semana 9.
\end{itemize}}

\textbf{Definición e implementación de pruebas de sistema}
\begin{\begin{itemize}
  \item Horas: 40 horas.
  \item Fechas: miercoles, jueves y viernes de la semana 9. Lunes y martes semana 10.
\end{itemize}}

\textbf{Pruebas alfa con el cliente}
\begin{\begin{itemize}
  \item Horas: 9 horas.
  \item Fechas: miercoles, jueves y viernes . Semana 10
\end{itemize}}
